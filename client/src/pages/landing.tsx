          ...
          <div className="text-center max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto">
              <div className="flex items-center bg-card p-4 rounded-lg border border-border">
                ...
                <span className="text-foreground font-medium">Slash unpredictable Kubernetes costs</span>
              </div>
              <div className="flex items-center bg-card p-4 rounded-lg border border-border">
                <CheckCircle className="text-accent h-5 w-5 mr-3" />
              ...
              <div className="flex items-center bg-card p-4 rounded-lg border border-border">
                <CheckCircle className="text-accent h-5 w-5 mr-3" />
                <span className="text-foreground font-medium">Engineers firefighting instead of shipping</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid lg:grid-cols-3 gap-8 mb-12">
            ...
            <Card className="text-center p-8 bg-card rounded-xl border border-border">
              ...
              <h3 className="text-xl font-semibold text-foreground mb-4">Security & audit anxiety (CIS/RBAC)</h3>
          ...
          <div className="text-center">
            <Button 
              ...
              className="bg-primary text-primary-foreground px-8 py-4 rounded-full text-lg font-semibold hover:bg-opacity-90 transition-colors"
              data-testid="button-pain-show-how-snapshot"
            >Yes, these sound familiar - show me how Snapshot works</Button>
          </div>
        </div>
      </section>
      {/* Solution Section */}
      ...
      <section className="py-16 lg:py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <Button 
            ...
            className="bg-primary text-primary-foreground px-10 py-4 rounded-full text-xl font-semibold hover:bg-opacity-90 transition-colors"
      ...
      <section className="py-16 lg:py-20 hero-gradient">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <Button 
            ...
            className="bg-primary text-primary-foreground px-12 py-5 rounded-full text-xl font-semibold hover:bg-opacity-90 transition-colors mb-6"
